...
private:
    ...
    int opt[2];
    int selects[22][2] = {{1,5},{6,8},{2,2},{3,3},{9,10},{5,5},{11,13},{18,20},{0,-1},{21,26},{0,-1},{14,17},{14,17},{14,17}};
    ...
    std::string trophies[4] = {"Final do Semestre","Muda de Curso","CarrolaCar","Caloiro de Elite"};
};
